...
//   { name: "SourcePlant", url: "/source-plant" },
//   { name: "FamilyPlant", url: "/family-plant" },
//   { name: "FloweringSeasonPlant", url: "/flowering-season-plant" },
// ];
...
const PhotoCard = ({ photo, index }) => {
  ...
  return (
    <Link href={`view/${photo?.plant?.plantId}`}>
